...
private object BuildDependencies {
  ...
  val compile: Seq[ModuleID] = dependencies(
    ...
    play26 = Seq("uk.gov.hmrc" %% "http-verbs-play-26" % "13.3.0" ),
    play27 = Seq("uk.gov.hmrc" %% "http-verbs-play-27" % "13.3.0" ),
    play28 = Seq("uk.gov.hmrc" %% "http-verbs-play-28" % "13.3.0" )
  )
